...
# Terminal shells								    
#assign [class="gnome-terminal|terminal"]		                       	→ 1
...
#assign [class="|nautilus|Nautilus"]                                                 → 4
...
#assign [class="Meld|Vlc|vlc"]                                                       → 5

# Workspace 6 all video related software
#assign [class="Thunderbird|Evolution"]                                              → 6
...
# Workspace 9 other clients
#assign [class="Gimp|Steam"]                                                          → 9
...
exec --no-startup-id conky -c /home/mika/.config/i3/oma.conkyrc
...
#workspace 1 related
bindsym $mod+F1 exec --no-startup-id exo-open --launch webbrowser;workspace 2;focus
#qwerty/azerty conflict with w
bindsym $mod+w exec --no-startup-id exo-open --launch webbrowser;workspace 2;focus
bindsym control+mod1+f exec --no-startup-id firefox;workspace 2; focus
bindsym control+mod1+v exec --no-startup-id vivaldi-snapshot;workspace 2; focus
bindsym control+mod1+g exec --no-startup-id google-chrome;workspace 3;focus
...
bindsym $mod+F8 exec --no-startup-id nautilus;workspace 8;focus
bindsym $mod+Shift+Return exec --no-startup-id nautilus; workspace 8;focus
bindsym control+mod1+b exec --no-startup-id nautilus;workspace 8;focus
...
#exec --no-startup-id feh --bg-scale ~/Kuvat/world_time_zone_2.png
exec --no-startup-id feh --bg-scale ~/Kuvat/402825627-fedora-wallpapers.jpg 
